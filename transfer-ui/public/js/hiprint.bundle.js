    ...
    var _o,
            ...
            return t.prototype.createPrintElementTypeHtml = function (t, e) {
                ...
                return e.forEach(function (t) {
                    ...
                    e.append(i), t.printElementTypes.forEach(function (t) {
                        i.append('<li><a class="ep-draggable-item" tid="' + t.tid + '" data="'+ t.data+'" >  ' + t.title + " </a></li>");
                    }), n.append(e);
        ...
        Ggt = function (t) {
            ...
            return Ht(e, t), e.prototype.getReizeableShowPoints = function () {
                ...
                var n = $('<div class="hiprint-printElement hiprint-printElement-image reproduction" style="position:absolute;"><div class="hiprint-printElement-image-content" style="width:100%;"></div></div>');
                return this.updateTargetImage(n, t, e), n;
                ...
                var i = t.find(".hiprint-printElement-image-content");
                i.find("img").length ? i.find("img").attr("src", n) : i.html('<img style="width:100%;" id="imgs" src="' + n + '">');
            }, e;
        }(mt),
        ...
        qt = function () {
            ...
            return t.createPrintElement = function (t, e) {
                return "text" == t.type ? new kt(t, e) : "image" == t.type ? new Ft(t, e):"images" == t.type ? new Ggt(t, e) : "longText" == t.type ? new Rt(t, e) : "table" == t.type ? new Ct(t, e) : "html" == t.type ? new jt(t, e) : "vline" == t.type ? new Mt(t, e) : "hline" == t.type ? new Xt(t, e) : "rect" == t.type ? new Ut(t, e) : "oval" == t.type ? new Kt(t, e) : void 0;
            }, t;
        }(),
        Qt = function () {
            function t(t) {
        ...
        Ce = function () {
            ...
            return t.prototype.subscribePaperBaseInfoChanged = function (t) {
                ...
                //页脚部分标注页目
                var index_I=$(".hiprint-printTemplate#hiprint-printTemplate>div").length;
                var i = $('<span class="hiprint-paperNumber"  style="position: absolute">' + index_I + "</span>");
        ...
        Fe = function () {
            ...
            return t.prototype.buildPagination = function () {
                ...
                for (var n = $('<ul class="hiprint-pagination"></ul>'), i = function i() {
                    var t = o,
                        i = $('<li class="list"><a href="javascript:void(0);">' + (t + 1) + "</a></li>");
                    i.click(function () {
                ...
                var r = $('<li><a href="javascript:void(0);">+</a></li>');// 定义增加按钮
                var delect = $('<li><a href="javascript:void(0);">-</a></li>');// 定义删除按钮
                n.append(r);n.prepend(delect); this.jqPaginationContainer.append(n),
                    r.click(function () {
                        // 点击增加按钮，默认将全部展示移除不显示页面
                        $(".hiprint-printTemplate#hiprint-printTemplate>div").removeClass("hipanel-zhanshi").addClass("hipanel-disable");
                        // 新添加页面并显示最新的页面
                        e.template.addPrintPanel(void 0, !0), e.buildPagination();
                        //给ul.hiprint-pagination的li列表添加点击事件，使其显示对应的页面
                        var panel_index=$(".hiprint-printTemplate#hiprint-printTemplate>div");
                        $(".hiprint-printPagination ul.hiprint-pagination li.list").on("click",function () {
                            //li对应的下标
                            var i2=$(this).index()-1;
                            //只显示点击相对应的页面
                            $(".hiprint-printTemplate#hiprint-printTemplate>div").removeClass("hipanel-zhanshi").eq(i2).addClass("hipanel-zhanshi");
                            $(".hiprint-printTemplate#hiprint-printTemplate>div").addClass("hipanel-disable").eq(i2).removeClass("hipanel-disable");
                        })
                    });
                delect.click(function () {

                    var panel_index=$(".hiprint-printTemplate#hiprint-printTemplate>div");
                    var index_I=$(".hiprint-printTemplate#hiprint-printTemplate").find(".hipanel-zhanshi").index()-1;
                    // 点击删除按钮，默认至少保留一个页面
                    if(panel_index.length>1){
                        // 删除页面并更新排序
                        e.template.delectPrintPanel(void 0, !0),
                            // 删除后默认显示前一页面，若从中间开始删除至第一个页面并需继续删除，且后方还有多个页面，删除后默认显示剩余的第一个直至剩余最后一个页面不可删除为止
                            index_I==-1?index_I=0:index_I=index_I;
                        $(".hiprint-printTemplate#hiprint-printTemplate>div").eq(index_I).addClass("hipanel-zhanshi").removeClass("hipanel-disable");
                        ...
                        $(".hiprint-printPagination ul.hiprint-pagination li.list").on("click",function () {
                            var i3=$(this).index()-1;
                            $(".hiprint-printTemplate#hiprint-printTemplate>div").removeClass("hipanel-zhanshi").eq(i3).addClass("hipanel-zhanshi");
                            $(".hiprint-printTemplate#hiprint-printTemplate>div").addClass("hipanel-disable").eq(i3).removeClass("hipanel-disable");
                        });
                    }
        ...
        Ie = function () {
            ...
            return t.prototype.design = function (t, e) {
                ...
                if (/^(hiprint-printPaper hidroppable design([1-9][0-9]*)|(([0]\.\d{1,2}|[1-9][0-9]*\.\d{1,2})))$/.test(t)) this.editingPanel.resize(void 0, parseFloat(t), parseFloat(e), !1); else {
                    var n = s.instance[t];
                    if (!n) throw new Error("not found pagetype:" + (t || ""));
                    this.editingPanel.resize(t, n.width, n.height, !1);
                    // var rate=s.instance[t].rate+"";
                    // $(".hiprint-printPaper.hidroppable.design").css({
                    //     "scale":s.instance[t].rate+"",
                    //     "transform-origin":"0 0",
                    // })
                }
            }, t.prototype.rotatePaper = function () {
                this.editingPanel.rotatePaper();
            }, t.prototype.delectPrintPanel = function (t, e) {  //手写添加删除功能
                var n = t ? new Oe(new xe(t), this.id) : this.createDefaultPanel();
                var hipanel_zhanshi=$(".hiprint-printTemplate#hiprint-printTemplate").find(".hipanel-zhanshi");
                //删除页面，并删除li,默认从尾部开始删除
                return t && (t.index = this.printPanels.length), e && (hipanel_zhanshi.remove(), n.design()), this.printPanels.pop(n), e && this.selectPanel(n.index), n;
